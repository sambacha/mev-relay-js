...
var _a = require('../model'),
  Users = _a.Users,
  generateSalt = _a.generateSalt,
  generateKeyID = _a.generateKeyID,
  generateSecretKey = _a.generateSecretKey,
  hashPass = _a.hashPass;
function main() {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_l) {
      switch (_l.label) {
        ...
        case 1:
          user = new (_a.apply(Users, [
            void 0,
            ((_k.hashedSecretKey = _l.sent()), (_k.salt = salt), _k),
          ]))();
